    ...
    it('generates weekly ideas when none exist', async () => {
        const prismaStub: SocialPlannerStore = {
            socialWeeklyIdea: {
                ...
                create: jest.fn().mockImplementation((args: Parameters<SocialPlannerStore["socialWeeklyIdea"]["create"]>[0]) => {
            ...
            socialSuggestion: { deleteMany: jest.fn(), createMany: jest.fn(), findMany: jest.fn(), create: jest.fn(), update: jest.fn(), count: jest.fn() },
            socialPost: { findMany: jest.fn(), findUnique: jest.fn(), create: jest.fn(), update: jest.fn(), delete: jest.fn(), count: jest.fn() },
            socialTemplate: { findMany: jest.fn(), create: jest.fn(), update: jest.fn(), delete: jest.fn(), count: jest.fn() },
            socialContentAsset: { findMany: jest.fn(), create: jest.fn(), update: jest.fn(), delete: jest.fn() },
