/*
  ...
  - You are about to drop the column `adjustment` on the `LedgerEntry` table. All the data in the column will be lost.
  - You are about to drop the column `hash` on the `LedgerEntry` table. All the data in the column will be lost.
  - You are about to drop the column `sourceTs` on the `LedgerEntry` table. All the data in the column will be lost.
  - You are about to drop the column `sourceTxId` on the `LedgerEntry` table. All the data in the column will be lost.
  - You are about to drop the column `sourceType` on the `LedgerEntry` table. All the data in the column will be lost.
  - You are about to drop the column `cashPostedAt` on the `Payout` table. All the data in the column will be lost.
  - You are about to drop the column `reconAt` on the `Payout` table. All the data in the column will be lost.
  - You are about to drop the column `reconDriftCents` on the `Payout` table. All the data in the column will be lost.
  - You are about to drop the column `reconLedgerNetCents` on the `Payout` table. All the data in the column will be lost.
  - You are about to drop the column `reconLineSumCents` on the `Payout` table. All the data in the column will be lost.
  - You are about to drop the column `reconStatus` on the `Payout` table. All the data in the column will be lost.
  ...
  - You are about to drop the `LedgerLine` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `PayoutRecon` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `PayoutReconLine` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `TaxJurisdiction` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `TaxProduct` table. If the table is not empty, all the data it contains will be lost.
  - A unique constraint covering the columns `[requestId]` on the table `SignatureArtifact` will be added. If there are existing duplicate values, this will fail.

*/
-- CreateEnum
CREATE TYPE "TicketCategory" AS ENUM ('issue', 'question', 'feature', 'other');
