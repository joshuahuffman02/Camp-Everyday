...
export const roadmapPhases: RoadmapPhase[] = [
    {
        ...
        milestones: [
            ...
            { id: 'payment-integration', name: 'Payment integration', description: 'Stripe Payment Intents, refunds, deposit captures (code ready, pending Stripe account setup)', status: 'in_progress' },
