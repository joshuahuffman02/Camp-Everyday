...
export function CalendarProvider({ children }: { children: React.ReactNode }) {
    ...
    const [reservationDrag, setReservationDrag] = useState<ReservationDragState>(defaultReservationDrag);
    ...
    const startReservationDrag = useCallback((payload: {
        reservationId: string;
        siteId: string;
        arrival: string;
        departure: string;
    ...
    const updateReservationDrag = useCallback((payload: {
        currentSiteId?: string;
        currentStartIdx?: number;
        currentEndIdx?: number;
    }) => {
