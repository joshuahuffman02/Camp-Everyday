                ...
                <div className="bg-card rounded-2xl shadow-lg p-8 md:p-10 space-y-8">
                    ...
                    <section>
                        <p className="text-muted-foreground leading-relaxed">
                            Thank you for joining the Keepr early access program. By participating, you&apos;re helping
                            us build a better campground management platform. This agreement outlines what you can
                            expect from us, and what we ask of you as a founding member.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            <li className="flex items-start gap-3">
                                ...
                                <span><strong>Early access</strong> to new features before general release</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-keepr-evergreen font-bold">2.</span>
                                <span><strong>Locked-in pricing</strong> at your current tier for as long as you remain a customer</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-keepr-evergreen font-bold">3.</span>
                                <span><strong>Direct communication</strong> with our team for support and feedback</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-keepr-evergreen font-bold">4.</span>
                                <span><strong>Influence</strong> over the product roadmap based on your feedback</span>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            <li className="flex items-start gap-3">
                                ...
                                <span><strong>Beta software:</strong> Keepr is under active development. Features may change, be added, or be removed.</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-slate-400 font-bold">2.</span>
                                <span><strong>No guarantees:</strong> We do not guarantee specific uptime, performance, or feature availability during the beta period.</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-slate-400 font-bold">3.</span>
                                <span><strong>Data backups:</strong> We recommend maintaining independent records for critical business operations.</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-slate-400 font-bold">4.</span>
                                <span><strong>Feedback welcome:</strong> We may contact you for feedback on features, usability, or your experience.</span>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            <li className="flex items-start gap-3">
                                ...
                                <span><strong>Report bugs:</strong> Let us know when something doesn&apos;t work as expected</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-keepr-evergreen">•</span>
                                <span><strong>Share feedback:</strong> Tell us what you love, what frustrates you, and what you wish existed</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-keepr-evergreen">•</span>
                                <span><strong>Be patient:</strong> We&apos;re a small team working hard to build something great</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-keepr-evergreen">•</span>
                                <span><strong>Stay engaged:</strong> Your active use helps us understand real-world needs</span>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            permission. We&apos;re happy to work with you on case studies or testimonials when ready.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            we&apos;ll work with you to export your data. Your locked-in pricing remains valid only
                            while you maintain continuous active service.
                        </p>
                    </section>
                    ...
                    <section className="border-t border-border pt-8">
                        <p className="text-muted-foreground text-sm">
                            ...
                            <a href="mailto:founders@keeprstay.com" className="text-keepr-evergreen hover:underline">
