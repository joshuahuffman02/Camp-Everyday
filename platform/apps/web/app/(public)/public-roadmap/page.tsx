      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={block.id} className="bg-card border border-border rounded-2xl shadow-sm p-4 flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xs uppercase tracking-wide text-muted-foreground">{block.label}</div>
        ...
        <div className="text-center text-sm text-muted-foreground space-y-2">
          ...
          <div className="flex justify-center gap-3">
            <Link href="/roadmap" className="text-keepr-evergreen hover:text-keepr-evergreen-light font-medium">
              Admin Roadmap
            </Link>
            <span className="text-muted-foreground">•</span>
            <Link href="/roadmap/public" className="text-keepr-evergreen hover:text-keepr-evergreen-light font-medium">
              Public roadmap doc
            </Link>
          </div>
        </div>
