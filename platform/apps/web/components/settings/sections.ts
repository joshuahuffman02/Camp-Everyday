...
export const categorySections: Record<string, Section[]> = {
  property: [
    ...
    { id: "localization", label: "Localization", href: "/dashboard/settings/central/property/localization" },
  ...
  bookings: [
    ...
    { id: "promotions", label: "Promotions", href: "/dashboard/settings/central/bookings/promotions" },
  ...
  access: [
    ...
    { id: "permissions", label: "Permissions", href: "/dashboard/settings/central/access/permissions" },
  ...
  system: [
    ...
    { id: "templates", label: "Email Templates", href: "/dashboard/settings/central/system/templates" },
    { id: "notifications", label: "Notifications", href: "/dashboard/settings/central/system/notifications" },
