            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-keepr-clay/10 rounded-full mb-6">
                        <svg className="w-5 h-5 text-keepr-clay" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-muted-foreground text-sm">
                                <li className="flex items-start gap-2">
                                    <svg className="w-4 h-4 text-keepr-clay mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
