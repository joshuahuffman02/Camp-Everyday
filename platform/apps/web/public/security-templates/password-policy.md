...
This policy establishes requirements for creating, managing, and protecting passwords and access credentials for all systems used by [Campground Name].
...
- Security systems and gate access
...
Contact management for approved options and setup assistance.

## 4. Account Management

### 4.1 Individual Accounts

- Each employee must have their own unique login credentials
- Sharing passwords is strictly prohibited
- Generic accounts (e.g., "frontdesk") should be eliminated
...
- Contact manager for immediate unlock if needed
...
- [ ] Any system with guest data access

### 5.1 Approved MFA Methods

1. Authenticator apps (preferred): Google Authenticator, Authy
2. SMS text codes (acceptable)
3. Hardware keys (optional): YubiKey
...
- See someone looking at your screen while logging in

**Report to:** [Manager Name] at [Phone/Email]
