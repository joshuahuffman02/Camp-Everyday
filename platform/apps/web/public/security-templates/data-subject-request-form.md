...
Use this form to submit a request regarding your personal data. We will respond to your request within 30 days. Please complete all applicable sections.

Mail completed form to: [Address]
Or email to: [Privacy Email Address]
...
## Section 4: Specific Data Categories

If you are requesting access or deletion, please indicate which categories of data (check all that apply):

- [ ] Contact information (name, address, email, phone)
- [ ] Identification information (driver's license, vehicle info)
- [ ] Reservation history
- [ ] Payment transaction records
- [ ] Communications (emails, notes)
- [ ] Marketing preferences
- [ ] Security records (if applicable)
- [ ] All personal information

---

## Section 5: Format Preference (for Access Requests)
...
## Section 6: Authorized Agent (if applicable)
...
- I am the individual whose personal information is the subject of this request, OR I am authorized to act on behalf of that individual
