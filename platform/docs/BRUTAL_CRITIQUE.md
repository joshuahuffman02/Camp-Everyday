...
- **Fix**: Decouple everything. Reservations should only manage *dates and IDs*; Pricing and Compliance should be external "guards."
...
---
*This critique is intended to identify the wall you will hit at 100x scale.*
